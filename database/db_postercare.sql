...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2019 at 09:12 AM
...
(1, 1, 'dswd', '$2y$10$AI.SIPKmZflT9tj3HG8Iz.nH62CxRGt/YZqcbeDg/YUN4DUHR6oZi', 1, 0, '2019-04-20 07:06:31');
...
--
-- Dumping data for table `y_video`
--

INSERT INTO `y_video` (`y_video_id`, `y_video_link`, `y_video_title`, `y_archive`, `y_created`) VALUES
(1, 'http://www.youtube.com/watch?v=Ahg6qcgoay4', 'a', 0, '2019-05-01 06:40:00'),
(2, 'https://www.youtube.com/watch?v=2j0q_UAAyCI', 'b', 0, '2019-05-01 06:40:08'),
(3, 'http://www.youtube.com/watch?v=Ahg6qcgoay4', 'c', 1, '2019-05-01 06:40:10');
...
--
ALTER TABLE `y_video`
  MODIFY `y_video_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
